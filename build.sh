#!/bin/bash
sudo apt-get update
sudo apt-get -y install aria2 qbittorrent lm-sensors vim neofetch npm openssh-server net-tools build-essential asciidoc binutils bzip2 gawk gettext git libncurses5-dev libz-dev patch python3 python2.7 unzip zlib1g-dev lib32gcc1 libc6-dev-i386 subversion flex uglifyjs git-core gcc-multilib p7zip p7zip-full msmtp libssl-dev texinfo libglib2.0-dev xmlto qemu-utils upx libelf-dev autoconf automake libtool autopoint device-tree-compiler g++-multilib antlr3 gperf wget curl swig rsync
...
cd Source
wget wget https://github.com/Zaphkito/Linux/raw/main/Source/buildopenwrt.sh
sh buildopenwrt.sh
crontab -e
